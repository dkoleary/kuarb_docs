...
export         PS1="$ "
export     control=~/working/puppet/control
export        mods=~/working/puppet
export          rg=${mpigit}/root
export      phrase="I hate little brown ducks"
export        Keys=${rg}/scripts/syslog_filters/ssh_key_list
export PSSH_OUTDIR=/home/dkoleary/working/pssh_output
export pdir=${PSSH_OUTDIR}
export llrst=/usr/local/ll
set -o vi
# unalias vi
alias ls="ls -F"
alias cd=mcd
...
alias facter="facter --external-dir=/opt/puppetlabs/facter/facts.d"
# alias python=python3
# alias pip=pip3
export PATH=/usr/local/git/bin:${PATH}:/home/dkoleary/.local/bin
# complete -C /home/dkoleary/.local/bin/aws_completer aws

alias pscp="/usr/bin/pscp.pssh"
umask 022
export EDITOR=vi
set -o vi
cd ${HOME}
